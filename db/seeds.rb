...
Coupon.create!(code: "SAVE20", discount: 20, expiration_date: Date.new(2024, 12, 31), merchant_id: 4, active: true, percentage:false)
Coupon.create!(code: "SAVE30", discount: 30, expiration_date: Date.new(2024, 12, 31), merchant_id: 4, active: true, percentage:false)
Coupon.create!(code: "SAVE40", discount: 40, expiration_date: Date.new(2024, 12, 31), merchant_id: 4, active: true, percentage:false)
Coupon.create!(code: "SAVE50", discount: 50, expiration_date: Date.new(2024, 12, 31), merchant_id: 4, active: true, percentage:false)
